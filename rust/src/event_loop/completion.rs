...
impl EventLoop {
    ...
    // Timer operations
    pub(crate) fn handle_set_timer(&mut self, _client_fd: i32, _buf: &[u8]) -> Reply {
    ...
    pub(crate) fn handle_get_timer_info(&mut self, _client_fd: i32, _buf: &[u8]) -> Reply {
    ...
    pub(crate) fn handle_cancel_timer(&mut self, _client_fd: i32, _buf: &[u8]) -> Reply {
